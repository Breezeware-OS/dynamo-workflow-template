...
@Service(value = "DynamoHealthShowcaseApp-physician-review-patient-information")
public class PhysicianReviewPatientInfoTaskManager implements TaskManager {
    ...
    public ProcessTaskData getInfoToActOnTask(String processId, String processInstanceUserDefinedKey,
        ...
        log.info("Entering getInfoToActOnTask() #PhysicianReviewPatientInfoTaskManager");
        ...
        log.info("Leaving getInfoToActOnTask() #PhysicianReviewPatientInfoTaskManager");
        return processTaskDataDto;
    }

    public void completeTask(TaskForm taskForm) {
        log.info("Entering completeTask() #PhysicianReviewPatientInfoTaskManager");
        ...
        log.info("Leaving completeTask() #PhysicianReviewPatientInfoTaskManager");
    }
