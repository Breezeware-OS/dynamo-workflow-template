...
@Slf4j
@Service(value = "DynamoHealthShowcaseApp-schedule-patient-followup")
@RequiredArgsConstructor
public class SchedulePatientFollowUp implements TaskManager {
    ...
    public ProcessTaskData getInfoToActOnTask(String processId, String processInstanceUserDefinedKey,
        ...
        log.info("Entering getInfoToActOnTask() #SchedulePatientFollowUp");
        ...
        log.info("Leaving getInfoToActOnTask() #SchedulePatientFollowUp");
        return processTaskDataDto;
    }

    public void completeTask(TaskForm taskForm) {
        log.info("Entering completeTask() #SchedulePatientFollowUp");
        ...
        log.info("Leaving completeTask() #SchedulePatientFollowUp");
    }
