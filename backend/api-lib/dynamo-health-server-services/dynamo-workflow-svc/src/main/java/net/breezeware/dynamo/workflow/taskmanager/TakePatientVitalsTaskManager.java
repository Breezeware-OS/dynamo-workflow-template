...
@Service(value = "DynamoHealthShowcaseApp-take-patient-vitals")
public class TakePatientVitalsTaskManager implements TaskManager {
    ...
    public ProcessTaskData getInfoToActOnTask(String processId, String processInstanceUserDefinedKey,
        ...
        log.info("Entering getInfoToActOnTask() #TakePatientVitalsTaskManager");
        ...
        log.info("Leaving getInfoToActOnTask() #TakePatientVitalsTaskManager");
        return processTaskDataDto;
    }

    public void completeTask(TaskForm taskForm) {
        log.info("Entering completeTask() #TakePatientVitalsTaskManager");
        ...
        log.info("Leaving completeTask() #TakePatientVitalsTaskManager");
    }
}